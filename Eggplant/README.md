...
_parmigiana di melanzane_</span>. For good reason, eggplant parmesan is an international favorite, yet the mystery of its origins are less well known. "Parmigiana" points to northern Italy as the birthplace of the dish, but some argue that the hard cheese from Parma is only a finishing touch, not an integral component. [The archive](http://www.cliffordawright.com/caw/food/entries/display.php/topic_id/4/id/109/) points to Naples instead, but a case can also been made for Sicily. "Parmigiana" could be a mispronunciation of "palmigiana," a Sicilian word for "shutters"—perhaps a metaphor for a casserole that alternates layers of fried eggplant rounds with tomato sauce and mozzarella. According to another theory, "parmigiana" also sounds like _parmiciana_, Sicilian for “Persian," so the credit could ultimately go to the culture that helped introduce eggplant to Mediterranean cooks long ago.[^1] But more important than who did what where first is a truth revealed by eggplant's jagged journey to kitchens across the globe: plants and their cultural repertoires rarely stay put; they much prefer to move and mingle.
<param ve-image
...
The late European Renaissance and early Baroque laced food and botanical imagery with sexual innuendo. According to _Gastronomica_ writer John Varriano, reproductive organs might have first been subbed for eggplant at the <span eid="Q1126723">Villa Farnesina</span> in Rome.[^10] During 1517–1518, the artist Raphael decorated the loggia with scenes featuring Cupid and Psyche, and surrounding his frescoes are <span data-mouseover-image-zoomto="1406,70,728,670">festoons by Giovanni da Udine,</span> who packed his paintings with garden produce. One arrangement includes a <span data-mouseover-image-zoomto="1841,176,293,270">phallic bottle gourd</span> penetrating a burst fig, while two eggplants stand in for testicles. Behind such visual ribaldry was the “doctrine of signatures,” the speculation that similar-looking objects or organisms share an essence.[^11] For example, eat walnuts to boost mental power, since these large seeds resemble a brain.
<param ve-image 
