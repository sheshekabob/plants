...
### The Eggplant Emoji
Just before the year 2000, Japanese telecom companies designed the <span eid="Q55267268">eggplant emoji</span> for the keyboard of icons that serve as the wordless shorthand of text messages and social media. The emoji is named Aubergine in Unicode, the universal standard for encoding linguistic and “picture” characters for electronic display. In 2010, the emoji keyboard was added to the Unicode Standard (version 6.0), and a year later, Apple made the keyboard accessible for iPhone users worldwide.[^1] Almost instantly, the eggplant emoji became code for a phallus when the Twitter handle @iFUXXS_witHer tweeted “im jelly no 🍆 😥” on September 30, 2011.[^2] In Japan, eggplant is so common that it was inducted into the first round of keyboard icons, but when smartphone users accessed the emoji in North America, where ”Aubergine” is a relatively empty culinary signifier—as opposed to the banana—it was ripe for a new meaning, one related to a more routine topic of wireless communication than eating the fruits of a less-known nightshade. Now, online foreplay or “sexting” is inseparable from a long, purple fruit with a bulbous end.
<param ve-image 
