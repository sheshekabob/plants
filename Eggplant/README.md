...
_parmigiana di melanzane_</span>. For good reason, eggplant parmesan is an international favorite, yet its origins are debated. "Parmigiana" points to northern Italy as the birthplace of the dish, but hard cheese from Parma is only a finishing touch, not an integral component. [The archive](http://www.cliffordawright.com/caw/food/entries/display.php/topic_id/4/id/109/) instead points to Naples, but a case has also been made for Sicily. "Parmigiana" could be a mispronunciation of "palmigiana," a Sicilian word for "shutters"—perhaps a metaphor for a casserole that alternates layers of fried eggplant rounds with tomato sauce and mozzarella. According to another theory, "parmigiana" also sounds like _parmiciana_, Sicilian for “Persian," so the credit could ultimately go to the culture that helped introduce eggplant to Mediterranean cooks long ago.[^1] But more important than who did what where first is a truth revealed by eggplant's jagged journey to kitchens across the globe: plants and their cultural repertoires rarely stay put; they much prefer to move and mingle.
<param ve-image
