...
### The Eggplant Emoji
Originally designed by Japanese telecom companies, the <span eid="Q55267268">eggplant emoji</span> is part of the keyboard of icons that serve as the wordless shorthand of text messages and social media. The emoji is named Aubergine in Unicode, the universal standard for encoding linguistic and “picture” characters for electronic display. In 2010, the emoji keyboard was added to the Unicode Standard (version 6.0), and a year later, Apple made the keyboard accessible for iPhone users worldwide.[^1] Almost instantly, the eggplant emoji became code for a phallus when, in 2011, the Twitter handle @iFUXXS_witHer tweeted “im jelly no 🍆 😥.”[^2] Eggplant is common enough in Japan for it to be a keyboard icon, but in the United States and Canada, where ”Aubergine” is a relatively empty culinary signifier—as opposed to the banana—the emoji was ripe for a new meaning, one related to a more routine topic of wireless communication than dining on a divisive nightshade. Now, online foreplay or “sexting” is inseparable from a long, purple fruit with a bulbous end.
<param ve-image 
